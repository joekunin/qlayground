...
var vec__8591 = axis;
var a_x = cljs.core.nth.call(null,vec__8591,(0),null);
var a_y = cljs.core.nth.call(null,vec__8591,(1),null);
var a_z = cljs.core.nth.call(null,vec__8591,(2),null);
var vec__8594 = v;
var x = cljs.core.nth.call(null,vec__8594,(0),null);
var y = cljs.core.nth.call(null,vec__8594,(1),null);
var z = cljs.core.nth.call(null,vec__8594,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8597,p__8598){
var vec__8605 = p__8597;
var u1 = cljs.core.nth.call(null,vec__8605,(0),null);
var u2 = cljs.core.nth.call(null,vec__8605,(1),null);
var u3 = cljs.core.nth.call(null,vec__8605,(2),null);
var vec__8608 = p__8598;
var v1 = cljs.core.nth.call(null,vec__8608,(0),null);
var v2 = cljs.core.nth.call(null,vec__8608,(1),null);
var v3 = cljs.core.nth.call(null,vec__8608,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8611_SHARP_){
return (p1__8611_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8612_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8613_SHARP_,angle_lr),angle_ud);
...
var map__8620 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8620__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8620__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__8622 = cljs.core._EQ_;
var expr__8623 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8622.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8623))){
return straight;
} else {
if(cljs.core.truth_(pred__8622.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8623))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8622.call(null,quil.middlewares.navigation_3d.space,expr__8623))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8622.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8623))){
return up;
} else {
if(cljs.core.truth_(pred__8622.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8623))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8622.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8623))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__8620,map__8620__$1,up,straight){
return (function (p1__8614_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8614_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__8620,map__8620__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8625_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8637_8648 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8637_8649__$1 = ((((!((map__8637_8648 == null)))?((((map__8637_8648.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8637_8648.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8637_8648):map__8637_8648);
var vec__8638_8650 = cljs.core.get.call(null,map__8637_8649__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8651 = cljs.core.nth.call(null,vec__8638_8650,(0),null);
var c_y_8652 = cljs.core.nth.call(null,vec__8638_8650,(1),null);
var c_z_8653 = cljs.core.nth.call(null,vec__8638_8650,(2),null);
var vec__8641_8654 = cljs.core.get.call(null,map__8637_8649__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8655 = cljs.core.nth.call(null,vec__8641_8654,(0),null);
var u_y_8656 = cljs.core.nth.call(null,vec__8641_8654,(1),null);
var u_z_8657 = cljs.core.nth.call(null,vec__8641_8654,(2),null);
var vec__8644_8658 = cljs.core.get.call(null,map__8637_8649__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8659 = cljs.core.nth.call(null,vec__8644_8658,(0),null);
var p_y_8660 = cljs.core.nth.call(null,vec__8644_8658,(1),null);
var p_z_8661 = cljs.core.nth.call(null,vec__8644_8658,(2),null);
quil.core.camera.call(null,p_x_8659,p_y_8660,p_z_8661,(p_x_8659 + c_x_8651),(p_y_8660 + c_y_8652),(p_z_8661 + c_z_8653),u_x_8655,u_y_8656,u_z_8657);
