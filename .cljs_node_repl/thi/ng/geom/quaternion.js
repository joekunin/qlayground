...
var self__ = this;
var ___$1 = this;
var and__19795__auto__ = cljs.core.sequential_QMARK_.call(null,q);
if(and__19795__auto__){
var and__19795__auto____$1 = ((4) === cljs.core.count.call(null,q));
if(and__19795__auto____$1){
var and__19795__auto____$2 = thi.ng.math.core.delta_EQ_.call(null,self__.x,cljs.core.first.call(null,q),eps);
if(cljs.core.truth_(and__19795__auto____$2)){
var and__19795__auto____$3 = thi.ng.math.core.delta_EQ_.call(null,self__.y,cljs.core.nth.call(null,q,(1)),eps);
if(cljs.core.truth_(and__19795__auto____$3)){
var and__19795__auto____$4 = thi.ng.math.core.delta_EQ_.call(null,self__.z,cljs.core.nth.call(null,q,(2)),eps);
...
var self__ = this;
var ___$1 = this;
var vec__31755 = cljs.core.get.call(null,opts,new cljs.core.Keyword(null,"translate","translate",1336199447));
var tx = cljs.core.nth.call(null,vec__31755,(0),null);
var ty = cljs.core.nth.call(null,vec__31755,(1),null);
var tz = cljs.core.nth.call(null,vec__31755,(2),null);
...
var wy = (self__.w * y2);
var wz = (self__.w * z2);
return (new thi.ng.geom.matrix.Matrix44((1.0 - (yy + zz)),(xy + wz),(xz - wy),0.0,(xy - wz),(1.0 - (xx + zz)),(yz + wx),0.0,(xz + wy),(yz - wx),(1.0 - (xx + yy)),0.0,(function (){var or__19807__auto__ = tx;
if(cljs.core.truth_(or__19807__auto__)){
return or__19807__auto__;
} else {
return 0.0;
}
})(),(function (){var or__19807__auto__ = ty;
if(cljs.core.truth_(or__19807__auto__)){
return or__19807__auto__;
} else {
return 0.0;
}
})(),(function (){var or__19807__auto__ = tz;
if(cljs.core.truth_(or__19807__auto__)){
return or__19807__auto__;
} else {
return 0.0;
...
thi.ng.geom.quaternion.Quat4.prototype.thi$ng$geom$core$IVectorTransform$transform_vector$arity$2 = (function (_,p__31758){
var self__ = this;
var vec__31759 = p__31758;
var vx = cljs.core.nth.call(null,vec__31759,(0),null);
var vy = cljs.core.nth.call(null,vec__31759,(1),null);
var vz = cljs.core.nth.call(null,vec__31759,(2),null);
var v = vec__31759;
var ___$1 = this;
...
var vec__31762 = (((thi.ng.math.core.abs_STAR_.call(null,stheta) < 0.001))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [0.5,0.5], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(Math.sin(((1.0 - t) * theta)) / stheta),(Math.sin((t * theta)) / stheta)], null));
var a = cljs.core.nth.call(null,vec__31762,(0),null);
var b = cljs.core.nth.call(null,vec__31762,(1),null);
var q__$1 = q;
...
var G__31768 = null;
var G__31768__2 = (function (self__,k){
var self__ = this;
var self____$1 = this;
var _ = self____$1;
return thi.ng.geom.quaternion.swizzle4.call(null,_,k,null);
});
var G__31768__3 = (function (self__,k,nf){
var self__ = this;
var self____$1 = this;
var _ = self____$1;
return thi.ng.geom.quaternion.swizzle4.call(null,_,k,nf);
});
G__31768 = function(self__,k,nf){
switch(arguments.length){
case 2:
return G__31768__2.call(this,self__,k);
case 3:
return G__31768__3.call(this,self__,k,nf);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__31768.cljs$core$IFn$_invoke$arity$2 = G__31768__2;
G__31768.cljs$core$IFn$_invoke$arity$3 = G__31768__3;
return G__31768;
})()
;

thi.ng.geom.quaternion.Quat4.prototype.apply = (function (self__,args31751){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args31751)));
});
...
thi.ng.geom.quaternion.Quat4.cljs$lang$ctorPrWriter = (function (this__20459__auto__,writer__20460__auto__,opt__20461__auto__){
return cljs.core._write.call(null,writer__20460__auto__,"thi.ng.geom.quaternion/Quat4");
});
...
var args31769 = [];
var len__21023__auto___31780 = arguments.length;
var i__21024__auto___31781 = (0);
while(true){
if((i__21024__auto___31781 < len__21023__auto___31780)){
args31769.push((arguments[i__21024__auto___31781]));

var G__31782 = (i__21024__auto___31781 + (1));
i__21024__auto___31781 = G__31782;
continue;
} else {
}
break;
...
thi.ng.geom.quaternion.quat.cljs$core$IFn$_invoke$arity$2 = (function (p__31772,w){
var vec__31773 = p__31772;
var x = cljs.core.nth.call(null,vec__31773,(0),null);
var y = cljs.core.nth.call(null,vec__31773,(1),null);
var z = cljs.core.nth.call(null,vec__31773,(2),null);
return (new thi.ng.geom.quaternion.Quat4(x,y,z,w,(-1)));
});

thi.ng.geom.quaternion.quat.cljs$core$IFn$_invoke$arity$1 = (function (p__31776){
var vec__31777 = p__31776;
var x = cljs.core.nth.call(null,vec__31777,(0),null);
var y = cljs.core.nth.call(null,vec__31777,(1),null);
var z = cljs.core.nth.call(null,vec__31777,(2),null);
var w = cljs.core.nth.call(null,vec__31777,(3),null);
return (new thi.ng.geom.quaternion.Quat4(x,y,z,w,(-1)));
});
...
var vec__31787 = thi.ng.math.core.normalize.call(null,q);
var x = cljs.core.nth.call(null,vec__31787,(0),null);
var y = cljs.core.nth.call(null,vec__31787,(1),null);
var z = cljs.core.nth.call(null,vec__31787,(2),null);
var w = cljs.core.nth.call(null,vec__31787,(3),null);
...
var vec__31794 = (function (){var G__31797 = (((order instanceof cljs.core.Keyword))?order.fqn:null);
switch (G__31797) {
case "xyz":
...
var a = cljs.core.nth.call(null,vec__31794,(0),null);
var b = cljs.core.nth.call(null,vec__31794,(1),null);
var c = cljs.core.nth.call(null,vec__31794,(2),null);
...
var G__31806 = (((k instanceof cljs.core.Keyword))?k.fqn:null);
switch (G__31806) {
case "x":
return _.x;
...
var G__31811 = cljs.core.assoc.call(null,acc,keymap.call(null,cljs.core.first.call(null,n__$1)),v.call(null,i));
var G__31812 = (i + (1));
var G__31813 = cljs.core.next.call(null,n__$1);
acc = G__31811;
i = G__31812;
n__$1 = G__31813;
continue;
...
var G__31817 = (((k instanceof cljs.core.Keyword))?k.fqn:null);
switch (G__31817) {
case "x":
return (new thi.ng.geom.quaternion.Quat4(v,_.y,_.z,_.w,(-1)));
