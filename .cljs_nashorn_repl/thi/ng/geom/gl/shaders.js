...
var vec__31031 = ((cljs.core.sequential_QMARK_.call(null,type))?type:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [type], null));
var type__$1 = cljs.core.nth.call(null,vec__31031,(0),null);
var default$ = cljs.core.nth.call(null,vec__31031,(1),null);
var opt = cljs.core.nth.call(null,vec__31031,(2),null);
var vec__31034 = thi.ng.geom.gl.shaders.uniform_types.call(null,type__$1);
var setter = cljs.core.nth.call(null,vec__31034,(0),null);
var u_cast = cljs.core.nth.call(null,vec__31034,(1),null);
var u_len = cljs.core.nth.call(null,vec__31034,(2),null);
var setter__$1 = (gl[[cljs.core.str("uniform"),cljs.core.str(setter)].join('')]);
return cljs.core.assoc.call(null,umap,id,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),type__$1,new cljs.core.Keyword(null,"default","default",-1987822328),default$,new cljs.core.Keyword(null,"setter","setter",1948354926),(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"int","int",-1741416922),null,new cljs.core.Keyword(null,"float","float",-1732389368),null,new cljs.core.Keyword(null,"bool","bool",1444635321),null,new cljs.core.Keyword(null,"sampler2D","sampler2D",-2107312644),null], null), null).call(null,type__$1))?((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
return setter__$1.call(gl,loc,u_cast.call(null,x));
});})(loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1))
:(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"mat3","mat3",402087048),null,new cljs.core.Keyword(null,"mat2","mat2",238424363),null,new cljs.core.Keyword(null,"mat4","mat4",-237531594),null], null), null).call(null,type__$1))?((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
...
:((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"vec2","vec2",-762258640),type__$1))?((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
...
:((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"vec3","vec3",1116680488),type__$1))?((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
...
:((cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"vec4","vec4",631182126),type__$1))?((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
...
:((function (loc,vec__31031,type__$1,default$,opt,vec__31034,setter,u_cast,u_len,setter__$1){
return (function (x){
...
return console.warn((new Date()),cljs.core.apply.call(null,cljs.core.str,cljs.core.interpose.call(null," ",cljs.core._conj.call(null,cljs.core._conj.call(null,(function (){var x__20951__auto__ = id;
...
var buffer = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"buffer","buffer",617295198));
var stride = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"stride","stride",-1172818435));
var size = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var type = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var normalized_QMARK_ = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"normalized?","normalized?",1246099953));
var offset = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"offset","offset",296498311));
var loc = cljs.core.get.call(null,map__31043__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
...
var G__31045 = gl;
G__31045.bindBuffer(thi.ng.geom.gl.webgl.constants.array_buffer,buffer);

G__31045.enableVertexAttribArray(loc__$1);

G__31045.vertexAttribPointer(loc__$1,(size | (0)),(function (){var or__20022__auto__ = type;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
return thi.ng.geom.gl.webgl.constants.float$;
}
})(),cljs.core.boolean$.call(null,normalized_QMARK_),(function (){var or__20022__auto__ = stride;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
return (0);
}
})(),(function (){var or__20022__auto__ = offset;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
return (0);
...
return console.warn((new Date()),cljs.core.apply.call(null,cljs.core.str,cljs.core.interpose.call(null," ",cljs.core._conj.call(null,(function (){var x__20951__auto__ = [cljs.core.str("Unknown shader attribute: "),cljs.core.str(id)].join('');
return cljs.core._conj.call(null,cljs.core.List.EMPTY,x__20951__auto__);
})(),"WARN"))));
}
});
...
return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p__31050){
var vec__31051 = p__31050;
var id = cljs.core.nth.call(null,vec__31051,(0),null);
var type = cljs.core.nth.call(null,vec__31051,(1),null);
...
return cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (p__31058){
var vec__31059 = p__31058;
var id = cljs.core.nth.call(null,vec__31059,(0),null);
var type = cljs.core.nth.call(null,vec__31059,(1),null);
...
thi.ng.geom.gl.shaders.prepare_shader_sources = (function thi$ng$geom$gl$shaders$prepare_shader_sources(p__31062){
...
var vs = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"vs","vs",-2022097090));
var fs = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"fs","fs",-2122926244));
var uniforms = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"uniforms","uniforms",-782808153));
var attribs = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var varying = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"varying","varying",685535123));
var prelude = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"prelude","prelude",-138977836));
var version = cljs.core.get.call(null,map__31065__$1,new cljs.core.Keyword(null,"version","version",425292698));
var gl3_QMARK_ = (function (){var and__20010__auto__ = version;
...
var src__$1 = [cljs.core.str(src),cljs.core.str((function (){var or__20022__auto__ = prelude;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
...
var vec__31070 = cljs.core.re_find.call(null,/ERROR: \d+:(\d+): (.*)/,line);
var _ = cljs.core.nth.call(null,vec__31070,(0),null);
var ln = cljs.core.nth.call(null,vec__31070,(1),null);
var msg = cljs.core.nth.call(null,vec__31070,(2),null);
...
console.debug((new Date()),cljs.core.apply.call(null,cljs.core.str,cljs.core.interpose.call(null," ",cljs.core._conj.call(null,cljs.core._conj.call(null,(function (){var x__20951__auto__ = id;
return cljs.core._conj.call(null,(function (){var x__20951__auto____$1 = cljs.core.nth.call(null,att,(1));
...
var map__31079 = spec;
var map__31079__$1 = ((((!((map__31079 == null)))?((((map__31079.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__31079.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__31079):map__31079);
var uniforms = cljs.core.get.call(null,map__31079__$1,new cljs.core.Keyword(null,"uniforms","uniforms",-782808153));
var attribs = cljs.core.get.call(null,map__31079__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var map__31080 = thi.ng.geom.gl.shaders.prepare_shader_sources.call(null,spec);
...
var vs_src = cljs.core.get.call(null,map__31080__$1,new cljs.core.Keyword(null,"vs-src","vs-src",-692281053));
var fs_src = cljs.core.get.call(null,map__31080__$1,new cljs.core.Keyword(null,"fs-src","fs-src",1463465927));
...
var G__31083_31085 = gl;
G__31083_31085.attachShader(prog,vs);

G__31083_31085.attachShader(prog,fs);

thi.ng.geom.gl.shaders.bind_attrib_locations.call(null,G__31083_31085,prog,attribs);

G__31083_31085.linkProgram(prog);
...
var G__31084_31086 = gl;
G__31084_31086.deleteShader(vs);

G__31084_31086.deleteShader(fs);
...
thi.ng.geom.gl.shaders.make_shader_from_dom = (function thi$ng$geom$gl$shaders$make_shader_from_dom(gl,p__31087){
...
var vs = cljs.core.get.call(null,map__31090__$1,new cljs.core.Keyword(null,"vs","vs",-2022097090));
var fs = cljs.core.get.call(null,map__31090__$1,new cljs.core.Keyword(null,"fs","fs",-2122926244));
