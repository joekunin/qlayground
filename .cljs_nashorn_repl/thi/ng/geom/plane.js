...
var args25901 = [];
var len__21238__auto___25908 = arguments.length;
var i__21239__auto___25909 = (0);
while(true){
if((i__21239__auto___25909 < len__21238__auto___25908)){
args25901.push((arguments[i__21239__auto___25909]));

var G__25910 = (i__21239__auto___25909 + (1));
i__21239__auto___25909 = G__25910;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args25901.length)].join('')));

}
});

thi.ng.geom.plane.plane_from_points.cljs$core$IFn$_invoke$arity$1 = (function (p__25904){
var vec__25905 = p__25904;
var a = cljs.core.nth.call(null,vec__25905,(0),null);
var b = cljs.core.nth.call(null,vec__25905,(1),null);
var c = cljs.core.nth.call(null,vec__25905,(2),null);
...
thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IProximity$closest_point$arity$2 = (function (p__25913,p){
var map__25914 = p__25913;
var map__25914__$1 = ((((!((map__25914 == null)))?((((map__25914.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25914.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25914):map__25914);
var _ = map__25914__$1;
var n = cljs.core.get.call(null,map__25914__$1,new cljs.core.Keyword(null,"n","n",562130025));
var map__25916 = this;
...
var ___$1 = map__25916__$1;
var n__$1 = cljs.core.get.call(null,map__25916__$1,new cljs.core.Keyword(null,"n","n",562130025));
...
thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IExtrude$extrude$arity$2 = (function (_,p__25918){
...
thi.ng.geom.types.Plane.prototype.thi$ng$geom$core$IMeshConvert$as_mesh$arity$2 = (function (_,p__25921){
...
var p = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"p","p",151049309));
var width = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var size = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"size","size",1098693007),1.0);
var mesh = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"mesh","mesh",456320595));
var attribs = cljs.core.get.call(null,map__25922__$1,new cljs.core.Keyword(null,"attribs","attribs",-137878093));
var ___$1 = this;
var w = ((function (){var or__20022__auto__ = width;
...
var h = ((function (){var or__20022__auto__ = height;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
return size;
...
var p__$1 = thi.ng.geom.core.closest_point.call(null,___$1,(function (){var or__20022__auto__ = p;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
...
var face = cljs.core.mapv.call(null,((function (w,h,flip_QMARK_,p__$1,q,___$1,map__25922,map__25922__$1,p,width,height,size,mesh,attribs){
return (function (p1__25912_SHARP_){
return thi.ng.math.core._PLUS_.call(null,p__$1,thi.ng.geom.core.transform_vector.call(null,q,p1__25912_SHARP_));
});})(w,h,flip_QMARK_,p__$1,q,___$1,map__25922,map__25922__$1,p,width,height,size,mesh,attribs))
...
return thi.ng.geom.core.add_face.call(null,(function (){var or__20022__auto__ = mesh;
if(cljs.core.truth_(or__20022__auto__)){
return or__20022__auto__;
} else {
...
var ___$1 = this;
var vec__25924 = ((cljs.core.map_QMARK_.call(null,l))?cljs.core.get.call(null,l,new cljs.core.Keyword(null,"points","points",-1486596883)):l);
var p = cljs.core.nth.call(null,vec__25924,(0),null);
var q = cljs.core.nth.call(null,vec__25924,(1),null);
...
var ___$1 = this;
var vec__25927 = ((cljs.core.map_QMARK_.call(null,ray))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get.call(null,ray,new cljs.core.Keyword(null,"p","p",151049309)),cljs.core.get.call(null,ray,new cljs.core.Keyword(null,"dir","dir",1734754661))], null):ray);
var p = cljs.core.nth.call(null,vec__25927,(0),null);
var dir = cljs.core.nth.call(null,vec__25927,(1),null);
